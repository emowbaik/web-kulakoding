<template>
  <div class="flex lg:mx-45 mx-12 justify-center items-center pb-12 lg:px-36">
    <div class="p-6 w-full flex flex-col gap-5 bg-tertiary rounded-md border border-primary text-primary">
      ...
      <div class="flex gap-12 flex-col">
            ...
            <label for="" class="relative flex items-center gap-5">
              <div class="">
                <input v-model="payload.komentar" type="text"
                  class="bg-secondary z-10 text-white placeholder:text-primary w-[15rem] lg:w-[54rem] border border-primary rounded-full py-4 pl-8"
        ...
        <div v-for="item in komentar" class="flex gap-5 items-center border-t-2 border-t-primary">
