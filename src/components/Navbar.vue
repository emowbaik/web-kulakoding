<template>
  <nav
    id="navbar"
    class="bg-primary px-6 shadow dark:bg-secondary text-kuning dark:text-primary"
  >
    <div class="flex items-center justify-between">
      ...
      <ul class="flex items-center gap-5 font-sans lg:mt-0">
        ...
        <li class="flex gap-3 relative text-end items-center">
          ...
          <div
            v-if="isClicked == true"
            class="absolute rounded-md shadow flex flex-col bg-slate-50 dark:bg-primary top-[56px] right-0 p-3 gap-1 z-10"
          >
            <div
