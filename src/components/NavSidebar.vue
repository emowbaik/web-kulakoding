                            ...
                            <TransitionChild as="template" enter="ease-in-out duration-300" enter-from="opacity-0"
                                ...
                                <div class="absolute top-0 right-0 mr-2 pt-4">
                                    <button type="button"
                                        ...
                                        Back
                                        <ArrowRightCircleIcon class="h-6 w-6 text-slate-900" aria-hidden="true" />
                                    </button>
                                </div>
                            </TransitionChild>
                                    ...
                                    <div class="flex justify-between m-2">
                                        ...
                                        <div>
                                            ...
                                            <button @click="toggleDark()" class="text-white mt-1">
                                                <img v-if="isDark" src="@/assets/img/Darkmode.png" alt="toggle"
                                                    class="w-12" />
                                                <img v-else src="@/assets/img/Lightmode.png" alt="toggle"
                                                    class="w-12" />
                                            </button>
                                        </div>
                                    </div>
