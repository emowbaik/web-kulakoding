<script setup>
    ...
    const { user, LoggedIn, Logout, Edit } = useAuth();
            ...
            <div class="flex flex-col justify-center items-center lg:my-5 my-20">
                <div class="flex flex-col items-center my-3">
                    ...
                    <h2 class="text-2xl text-center font-bold">{{ user.username }}
                        <hr style="width: 100px;height:2px;border-width:0;" class="bg-slate-900 dark:bg-white">
                    </h2>
                </div>
...
<style scoped>
    .input-field {
  @apply border-b border-b-primary h-9 text-xl focus:outline-none w-full;
}
</style>