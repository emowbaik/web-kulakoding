                    ...
                    <div class="flex flex-col flex-grow justify-between">
                        <div class="flex flex-col justify-center items-center mt-10 text-white">
                            ...
                            <span class="flex flex-col gap-3">
                                ...
                                <button type="submit"
                                    class="inline-flex mx-0 justify-center items-center gap-1 font-semibold rounded-md bg-kuning focus:bg-slate-300 border border-slate-900 hover:border-gray-400 dark:bg-transparent dark:focus:bg-slate-900 dark:border-gray-600 hover:dark:border-gray-400 shadow p-2 hover:bg-slate-400 text-slate-900">
                                    Confirm
                                </button>
                            </span>
                        </div>
                        <div class="text-sm mx-auto">
                            <p class="flex gap-1 text-kuning">
